...
public class Or extends Command {
     ...
     */
    public Or(int op1, int op2) {
        this.op1 = op1;
        this.op2 = op2;
    }

    /**
     * performs the logical bitwise "or" with the input on location op1 and the input
     * from location op2 and saves the result at the location of op1
     */
    @Override
    public void function() {
        String bin = Integer.toBinaryString(Integer.parseInt(App.memory.getMemory(
                op1, 1 << 2 + 2 + 1), 2)
                | Integer.parseInt(App.memory.getMemory(op2, 1 << 2 + 2 + 1), 2));
