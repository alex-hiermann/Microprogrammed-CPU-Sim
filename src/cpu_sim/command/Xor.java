...
public class Xor extends Command {
     ...
     */
    public Xor(int op1, int op2) {
        this.op1 = op1;
        this.op2 = op2;
    }

    /**
     * performs the logical bitwise "xor" with the input on location op1 and the input from location op2 and saves the result at the location of op1
     */
    @Override
